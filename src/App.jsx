...
import StartAdoption from "./pages/StartAdoption.jsx";
    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1 px-4 sm:px-6 lg:px-8 py-6 max-w-6xl mx-auto w-full">
        <Routes>
          ...
          <Route path="/adopt/:petId/start" element={<StartAdoption />} />
          <Route path="/adoption/confirmation/:petId" element={<AdoptionConfirmation />} />
